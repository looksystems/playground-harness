...
- The event set was later expanded to 18 events with [ADR 0022](0022-shell-and-registration-hooks.md), adding shell execution, registration, and CWD change hooks, then to 22 events with [ADR 0024](0024-has-skills-mixin.md), adding four `skill_*` hooks (mount, unmount, setup, teardown).
