...
class EmitsEventsTest extends TestCase
{
    public function testRegisterEvent(): void
    {
        ...
        $et = new EventType(name: 'test', description: 'a test', schema: []);
    ...
    {
        $obj = new EventEmitter();
        $et1 = new EventType(name: 'a', description: '', schema: []);
        $et2 = new EventType(name: 'b', description: '', schema: []);
    ...
    public function testAdhocEvent(): void
    {
        $obj = new EventEmitter();
        $obj->defaultEvents = [];
        $adhoc = new EventType(name: 'adhoc', description: 'inline', schema: []);
    ...
    {
        $obj = new EventEmitter();
        $registered = new EventType(name: 'reg', description: '', schema: []);
        $obj->registerEvent($registered);
        $adhoc = new EventType(name: 'adhoc', description: '', schema: []);
